<x-app-layout>
    <main>
        <div class="container">
          <h1 class="car-details-page-title">{{$car->maker->name}} {{$car->model->name}}
             - {{$car->year}}</h1>
...
@endforeach  </div>
              ...
              <div class="card car-detailed-description">
                ...
                <ul class="car-specifications">
                  <x-car-specification :featuers="$car->featuers"/>
            ...
            <div class="car-details card">
              <div class="flex items-center justify-between">
                <p class="car-details-price">{{ Number::currency($car->price, 'USD')  }}</p>
              ...
              <a href="tel:{{Str::mask($car->owner->phone,'*',-3)}}" class="car-details-phone">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
